<!--
   ...
   https://github.com/vwvtkxjobkvpqszygxmjvgaavwvfju/Ubuntu-Mainline-Kernel-Updater#readme
-->
About:<blockquote>
...
<pre><code>git clone git://github.com/vwvtkxjobkvpqszygxmjvgaavwvfju/Ubuntu-Mainline-Kernel-Updater</code></pre>

Step 2: Download (Method 2/5: Use <code>wget</code> to download a zip archive and extract it)
<pre><code>wget https://github.com/vwvtkxjobkvpqszygxmjvgaavwvfju/Ubuntu-Mainline-Kernel-Updater/archive/master.zip -O Ubuntu-Mainline-Kernel-Updater.zip
...
<pre><code>curl https://github.com/vwvtkxjobkvpqszygxmjvgaavwvfju/Ubuntu-Mainline-Kernel-Updater/archive/master.zip > Ubuntu-Mainline-Kernel-Updater.zip
unzip Ubuntu-Mainline-Kernel-Updater.zip</code></pre>

Step 2: Download (Method 4/5: Use <code>wget</code> to download a tar.gz archive and extract it)
<pre><code>wget https://github.com/vwvtkxjobkvpqszygxmjvgaavwvfju/Ubuntu-Mainline-Kernel-Updater/archive/master.tar.gz -O Ubuntu-Mainline-Kernel-Updater.tar.gz
...
<pre><code>curl https://github.com/vwvtkxjobkvpqszygxmjvgaavwvfju/Ubuntu-Mainline-Kernel-Updater/archive/master.tar.gz > Ubuntu-Mainline-Kernel-Updater.tar.gz
tar -zxvf Ubuntu-Mainline-Kernel-Updater-master.tar.gz</code></pre>
